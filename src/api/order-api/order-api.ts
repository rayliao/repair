...
export const postOrderList = (
    ...
    {url: `http://api.zxjl/order/list`, method: 'POST'
    },
    );
  }
...
export const getPostOrderListMutationKey = () => [`http://api.zxjl/order/list`] as const;
...
export const postOrderPost = (
    ...
    {url: `http://api.zxjl/order/post`, method: 'POST',
...
export const getPostOrderPostMutationKey = () => [`http://api.zxjl/order/post`] as const;
...
export const getOrderCancelReasons = (
    ...
    {url: `http://api.zxjl/order/cancel/reasons`, method: 'GET'
    },
    );
  }
...
export const getGetOrderCancelReasonsKey = () => [`http://api.zxjl/order/cancel/reasons`] as const;
...
export const postOrderCancel = (
    ...
    return createTaroAxiosInstance<ApiResult>(
    {url: `http://api.zxjl/order/cancel`, method: 'POST',
      headers: {'Content-Type': 'application/json-patch+json', },
...
export const getPostOrderCancelMutationKey = () => [`http://api.zxjl/order/cancel`] as const;
